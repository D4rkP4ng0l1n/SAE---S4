...
public class Esporter_ModifEcurie extends JPanel{
	...
	private static JLabel previsualisationImage, messageErreur;
	private static JTextField nomEcurie, nomCEO;

	public Esporter_ModifEcurie() {
		...
		JLabel Nom = new JLabel("Esporter");
		panel_2.add(Nom);
		...
		JLabel lblNewLabel_2 = new JLabel("Modification d'une ecurie");
	...
	public static boolean labelsVide() {
		return nomEcurie.getText().length() == 0 && nomCEO.getText().length() == 0;
	}
	...
	public static void setImage(String path) {
		...
		img = img.getScaledInstance(512, 512, Image.SCALE_DEFAULT);
