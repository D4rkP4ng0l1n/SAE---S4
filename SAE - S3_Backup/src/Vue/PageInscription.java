...
public class PageInscription extends JPanel {
	...
	public PageInscription() {
		...
		JLabel lblNewLabel_4 = new JLabel("Type de compte :");
		panel_15.add(lblNewLabel_4);

		JPanel panel_16 = new JPanel();
		panel_8.add(panel_16);

		JLabel typeCompte = new JLabel("Ecurie");
		typeCompte.setHorizontalAlignment(SwingConstants.CENTER);
		panel_16.add(typeCompte);
